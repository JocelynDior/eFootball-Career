    ...
    <div style={{ minHeight: "100vh", background: "transparent", fontFamily: "'Inter', sans-serif", position: "relative" }}>
      ...
      <div style={{ padding: "32px 20px 80px", margin: "0 auto" }}>
        ...
        <div style={{ background: "rgba(255,170,0,0.08)", border: "1px solid rgba(255,170,0,0.4)", borderRadius: "14px", padding: "14px 18px", marginBottom: "28px" }}>
          <div style={{ color: "#ffaa00", fontWeight: 800, fontSize: "1.8rem", marginBottom: "4px", textTransform: "uppercase", letterSpacing: "1px" }}>⚠️ Disclaimer</div>
          <div style={{ color: "rgba(255,255,255,0.75)", fontSize: "1.8rem", lineHeight: 1.6 }}>
