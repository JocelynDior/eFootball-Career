...
const TOURNAMENT_NAME_KEY = "bundesliga";
        ...
        {isAdmin && (
          <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 12 }}>
            <button
              ...
              style={{
                background: pending.length > 0 ? "rgba(232,0,13,0.15)" : "rgba(255,255,255,0.05)",
                border: `1px solid ${pending.length > 0 ? "rgba(232,0,13,0.5)" : "rgba(255,255,255,0.15)"}`,
                color: pending.length > 0 ? "#E8000D" : "rgba(255,255,255,0.5)",
            ...
            >
              ⏳ PENDING RESULTS
              {pending.length > 0 && (
                <span style={{ background: "#E8000D", color: "#fff", borderRadius: "50%", width: 22, height: 22, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.75rem", fontWeight: 700, fontFamily: "inherit" }}>
                  {pending.length}
                </span>
              )}
            </button>
              ...
              <>
                <div style={{ display: "flex", justifyContent: "center", marginBottom: 16 }}>
                  <button
                    ...
                    style={{ background: "linear-gradient(135deg, #E8000D, #FF4444)", border: "none", color: "#fff", padding: "14px 32px", borderRadius: 30, fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.4rem", letterSpacing: 2, cursor: "pointer", boxShadow: "0 4px 20px rgba(232,0,13,0.4)" }}
                  >
                    + ADD RESULT
                  </button>
                </div>
