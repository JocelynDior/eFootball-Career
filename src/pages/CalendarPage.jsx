...
// Tournament card — team names 2x bigger
function TournamentCard({ tournament, getTeamIcon }) {
  const [open, setOpen] = useState(false);
  const fixtures = tournament.fixtures || [];
  return (
    <div
      style={{ background: "rgba(0,0,0,0.72)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "1.1rem", padding: "0.9rem 1rem", marginBottom: "0.8rem", transition: "border-color 0.2s" }}
          ...
          {fixtures.map((f, i) => {
            ...
            return (
              <div key={i} style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr) 60px minmax(0,1fr)", alignItems: "center", gap: "8px", padding: "0.7rem 0", borderBottom: i < fixtures.length - 1 ? "1px solid rgba(255,255,255,0.05)" : "none" }}>
                ...
                <div style={{ textAlign: "center", fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.3rem", color: "#fff", fontWeight: 700 }}>vs</div>
...
function Spinner() {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "80px 20px", gap: "20px" }}>
      <div style={{ width: "52px", height: "52px", borderRadius: "50%", border: "4px solid rgba(255,255,255,0.1)", borderTop: "4px solid #FF1493", animation: "spin 0.8s linear infinite" }} />
      <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.4rem", letterSpacing: "3px", color: "rgba(255,255,255,0.5)" }}>LOADING CALENDAR...</div>
    </div>
  );
}
...
export default function CalendarPage() {
  ...
  function evHasTeam(ev, team) {
    return ev?.tournaments?.some(t => (t.fixtures || []).some(f =>
  ...
  const isLoading = calData === null || activeMonths === null;
  ...
  return (
    <div style={{ minHeight: "100vh", background: "transparent", fontFamily: "'Inter', sans-serif" }}>
      ...
      {/* Day Detail Modal — all text 2x bigger */}
          ...
          {selectedEv ? (
            <>
              ...
              {(selectedEv.eventPairs || []).length === 0
                ? <div style={{ color: "rgba(255,255,255,0.4)", fontSize: "1.7rem", padding: "1rem" }}>No events scheduled.</div>
                : (selectedEv.eventPairs || []).map((pair, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: "0.8rem", background: "rgba(0,0,0,0.4)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "0.8rem", padding: "0.9rem", marginBottom: "0.6rem" }}>
                    {/* EVENT label 2x */}
                    <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.2rem", color: "#fff", fontWeight: 700, whiteSpace: "nowrap" }}>EVENT {i + 1}</div>
              ...
              <div style={{ background: "rgba(0,0,0,0.6)", border: "1px solid rgba(255,255,255,0.15)", borderRadius: "0.7rem", padding: "0.75rem 0.9rem", color: "#fff", fontSize: "1.8rem", fontWeight: 600, marginBottom: "1rem" }}>
